                     ...
                     <td colspan=4 class="dvInnerHeader">
                        <div style="float:left;font-weight:bold;"><a href="javascript:showHideStatus('tbl{$leadheadtext}','aid{$leadheadtext}',1);">
                                {if $showdisplead eq 'block'}
                                    <span id="aid{$leadheadtext}" class="slds-accordion" style="display: inline-block;">
                    ...
                    <tr>{strip}
                         <td colspan=4 class="dvInnerHeader">
                            ...
                            {if $showdispcon eq 'block'}
                                   <span id="aid{$conheadtext}" class="slds-accordion" style="display: inline-block;">
                                    <svg class="slds-section__title-action-icon slds-button__icon slds-button__icon_left" aria-hidden="true">
                                       <use xlink:href="./include/LD/assets/icons/utility-sprite/svg/symbols.svg#switch" xmlns:xlink="http://www.w3.org/1999/xlink" />
                                    </svg>                                   
                                   </span>
                  ...
                  <tr>{strip}
                     <td colspan=4 class="dvInnerHeader">
                        <div style="float:left;font-weight:bold;"><a href="javascript:showHideStatus('tbl{$messageheadtext}','aid{$messageheadtext}',1);">
                                ...
                                <span id="aid{$messageheadtext}" class="slds-accordion" style="display: inline-block;">
                                    <svg class="slds-section__title-action-icon slds-button__icon slds-button__icon_left" aria-hidden="true">
                                       <use xlink:href="./include/LD/assets/icons/utility-sprite/svg/symbols.svg#switch" xmlns:xlink="http://www.w3.org/1999/xlink" />
                                    </svg>
                                </span>
                  ...
                  <tr>{strip}
                     <td colspan=4 class="dvInnerHeader">
                        <div style="float:left;font-weight:bold;"><a href="javascript:showHideStatus('tbl{$taskheadtext}','aid{$taskheadtext}',1);">
                                ...
                                <span id="aid{$taskheadtext}" class="slds-accordion" style="display: inline-block;">
                                    <svg class="slds-section__title-action-icon slds-button__icon slds-button__icon_left" aria-hidden="true">
                                       <use xlink:href="./include/LD/assets/icons/utility-sprite/svg/symbols.svg#switch" xmlns:xlink="http://www.w3.org/1999/xlink" />
                                    </svg>                                
                                </span>
                  ...
                  <tr>{strip}
                     <td colspan=4 class="dvInnerHeader">
                        <div style="float:left;font-weight:bold;"><a href="javascript:showHideStatus('tbl{$potentialheadtext}','aid{$potentialheadtext}',1);">
                                ...
                                <span id="aid{$potentialheadtext}" class="slds-accordion" style="display: inline-block;">
                                    <svg class="slds-section__title-action-icon slds-button__icon slds-button__icon_left" aria-hidden="true">
                                       <use xlink:href="./include/LD/assets/icons/utility-sprite/svg/symbols.svg#switch" xmlns:xlink="http://www.w3.org/1999/xlink" />
                                    </svg>                                
                                </span>
                  ...
                  <tr>{strip}
                     <td colspan=4 class="dvInnerHeader">
                        <div style="float:left;font-weight:bold;"><a href="javascript:showHideStatus('tbl{$accountheadtext}','aid{$accountheadtext}',1);">
                                ...
                                <span id="aid{$accountheadtext}" class="slds-accordion" style="display: inline-block;">
                                    <svg class="slds-section__title-action-icon slds-button__icon slds-button__icon_left" aria-hidden="true">
                                       <use xlink:href="./include/LD/assets/icons/utility-sprite/svg/symbols.svg#switch" xmlns:xlink="http://www.w3.org/1999/xlink" />
                                    </svg>                                
                                </span>
		...
		<tr>{strip}
			<td colspan=4 class="dvInnerHeader">
				<div style="float:left;font-weight:bold;"><a href="javascript:showHideStatus('tbl{$segmentheadtext}','aid{$segmentheadtext}',1);">
						...
						<span id="aid{$segmentheadtext}" class="slds-accordion" style="display: inline-block;">
              <svg class="slds-section__title-action-icon slds-button__icon slds-button__icon_left" aria-hidden="true">
                  <use xlink:href="./include/LD/assets/icons/utility-sprite/svg/symbols.svg#switch" xmlns:xlink="http://www.w3.org/1999/xlink" />
              </svg>            
            </span>
	...
	<div style="width:auto;display:{$showdisptags};" id="tbl{$segmentheadtext}" >
		...
		<table border=0 cellspacing=0 cellpadding=0 width="100%" class="small">
			<tr>
                ...
                <br>
<div align="center">
<input title="{$APP.LBL_SEARCH_BUTTON_TITLE}" accessKey="{$APP.LBL_SEARCH_BUTTON_KEY}" class="slds-button slds-button_brand searchbutton" type="submit" name="button" value="  {$APP.LBL_SEARCH_BUTTON_LABEL}  " id="searchbutton">
</div>
</form>
</td>
</tr>
...
<div align="center">
<br>
<input title="{$MOD.CONVERT_TASK}" accessKey="V" class="sdls-button sdls-button-neutral convertbutton" type="submit" name="button" id="converttask" value="  {$MOD.CONVERT_TASK}  " onclick="this.form.convertto.value='task'; return task('');">
</div>
  </div>
{/if}
  <h3><a href="#">{'Potentials'|@getTranslatedString:'Potentials'}</a>
  </h3>
  <div>
      <table border=0 cellspacing=0 cellpadding=0 width="100%" class="small">
      <tr>
